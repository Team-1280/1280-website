...
const Leadership = () => (
    <>
        <section>
            <div className='bg-white relative h-[30%] w-full justify-center items-center px-7 py-5'>
                <div className='relative bg-[#717070] justify-center grid items-center w-54/55 h-1/4'>
                    <div className='text-white font-orbitron text-3xl text-left px-20 pb-5 pt-5'>
                        Student Leadership
                    </div>
        ...
        <section>
            <div className="h-[110vh] relative w-full px-70 py-5">
                <div className="font-bricolage">
                    ...
                    <div className='absolute top-[15%] left-[33%] grid text-center -translate-x-1/2'>
                        <div className='text-left text-lg'>
                            <div className='text-black font-bold font-base'>
                                Rohan Gawde
                            </div>
                    ...
                    <div className='absolute top-[15%] left-[66%] grid text-center -translate-x-1/2'>
                        <div className='text-left text-lg'>
                            <div className='text-black font-bold font-base'>
                                Analisse Corona
                            </div>
