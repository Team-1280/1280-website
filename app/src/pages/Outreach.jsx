        ...
        <>
            ...
            <section className='text-left bg-white relative h-auto w-full px-24 py-18 overflow-hidden'>
                <div className='min-w-160'>
                    ...
                    <div className='gray-box font-sans px-10 py-10 text-white text-lg'>
            ...
            <section className='bg-white relative w-full h-auto flex flex-col gap-16 overflow-hidden'>
                <div className="size-full flex flex-row justify-center-safe items-center gap-24">
                    ...
                    <img src='/outreach1.png' className='h-100 rounded-xl' alt="Outreach 1"></img>
                </div>
                <div className="size-full flex flex-row justify-center-safe items-center gap-24">
                    <div className="relative w-auto h-100 flex items-center justify-center">
                        <img src="/bg-logo.png" className="max-w-none h-[100%] opacity-25" alt="Background Logo" />
                    ...
                    <img src='/outreach2.png' className='h-100 rounded-xl' alt="Outreach 2"></img>
                </div>
                <div className="size-full flex flex-row justify-center-safe items-center gap-24">
                    <div className="relative w-auto h-100 flex items-center justify-center">
                        <img src="/bg-logo.png" className="max-w-none h-[100%] opacity-25" alt="Background Logo" />
                    ...
                    <img src='/outreach3.png' className='h-100 rounded-xl' alt="Outreach 3"></img>
                </div>
                <div className="size-full flex flex-row justify-center-safe items-center gap-24">
                    <div className="relative w-auto h-100 flex items-center justify-center">
                        <img src="/bg-logo.png" className="max-w-none h-[100%] opacity-25" alt="Background Logo" />
