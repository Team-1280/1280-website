...
const Outreach = () => {
    ...
    <>
        <section>
            <div className="w-screen">
                <div className="relative">
                    ...
                    <div
                        className="absolute top-0 left-0 w-full h-full flex items-center px-20 pb-5 z-10"
                    >
                        <div className="text-white text-2xl text-left px-10 p-4 rounded pointer-events-auto">
        ...
        <section>
            <div className='text-left bg-white relative h-[60vh] w-screen pl-12'>
                <div className='px-10 pt-12 text-black text-5xl font-bold'>Outreach Events</div>
                <hr className="mx-10 my-8 border-gray-300 border-t-4 w-50/55"></hr>
                <div className='relative bg-[#52565e] mx-10 justify-center grid items-center w-50/55 h-3/8'>
                <div className="text-lg max-w-[90vw]">
                    <div className="px-10 text-white">In addition to our ongoing programs, our team participates in a variety of one-off or annual events that connect us with the local community. These events often include robot demonstrations, hands-on STEM activities, and opportunities for community members of all ages to learn about engineering and FIRST.</div>
                    </div>
                </div>
            </div>
        </section>
        <section>
            <div className='text-left bg-white relative h-[300vh] w-screen pl-12'>
                <div className="relative">
                ...
                <div className="relative">
                    <img src="/bg-logo.png" className="absolute h-[60vh] top-130 left-[10%] opacity-80" alt="Background Logo" />
                    <div
                        className="absolute top-0 left-0 w-full h-full flex px-20 pb-5 z-10"
                    >
                        <div className="text-black text-xl mx-80 px-5 ml-80 p-4">
                            <div class="absolute top-160 left-30 mr-190 text-center">
                ...
                <div className="relative">
                    <img src="/bg-logo.png" className="absolute h-[60vh] top-390 left-[10%] opacity-80" alt="Background Logo" />
                    <div
                        className="absolute top-0 left-0 w-full h-full flex px-20 pb-5 z-10"
                    >
                        <div className="text-black text-xl mx-80 px-5 ml-80 p-4">
                            <div class="absolute top-420 left-30 mr-190 text-center">
                ...
                <img src='/outreach1.png' className='absolute h-[60vh] top-[0%] left-[70%] -translate-x-1/2' alt="Outreach 1"></img>
                <img src='/outreach2.png' className='absolute h-[60vh] top-[25%] left-[70%] -translate-x-1/2' alt="Outreach 2"></img>
        ...
        <section>
            <div className='text-left bg-white relative h-[60vh] w-screen pl-12'>
                <div className='px-10 pt-12 text-black text-5xl font-bold'>Outreach Programs</div>
                <hr className="mx-10 my-8 border-gray-300 border-t-4 w-50/55"></hr>
                <div className='relative bg-[#52565e] mx-10 justify-center grid items-center w-50/55 h-1/4'>
                <div className="text-lg max-w-[90vw]">
                    <div className="px-10 text-white">Beyond one-time events, our team is committed to ongoing outreach programs that foster STEM education and strengthen connections within our community.</div>
                    </div>
                </div>
            </div>
        </section>
        <section>
            <div className='text-left bg-white relative h-[200vh] w-screen pl-12'>
                    <img src="/bg-logo.png" className="absolute left-10 h-[185vh] opacity-80" alt="Background Logo" />
                    <div
                        className="absolute top--5 left-0 w-full h-full flex px-20 pb-5 z-10"
                    >
                        <div className="text-black text-xl mx-80 px-5 ml-80 p-4">
                            <div class="absolute left-175 mr-40 text-center">
                            ...
                            <div class="absolute top-97 left-175 mr-40 text-center">
                            ...
                            <div class="absolute top-197 left-175 mr-40 text-center">
                    ...
                    <img src='/fll-logo.png' className='absolute h-[40vh] top-[-3%] left-[25%] -translate-x-1/2' alt="FLL Logo"></img>
                    <img src='/srv-logo.png' className='absolute h-[40vh] top-[25%] left-[25%] -translate-x-1/2' alt="SRV Logo"></img>
                    <img src='/outreach5.png' className='absolute h-[40vh] top-[55%] left-[25%] -translate-x-1/2' alt="Outreach 5"></img>
            </div>
        </section>
    </>
    )
