...
const Outreach = () => {
    ...
    <>
        ...
        <section>
            <div className='text-left bg-white relative h-[60vh] w-full pl-12'>
                ...
                <div className='relative bg-[#717070] mx-10 justify-center grid items-center w-50/55 h-3/8'>
        ...
        <section>
            <div className='text-left bg-white relative h-[60vh] w-full pl-12'>
                ...
                <hr className="mx-10 my-8 border-gray-300 border-t-4 w-50/55"></hr>
                <div className='relative bg-[#717070] mx-10 justify-center grid items-center w-50/55 h-1/4'>
                <div className="text-lg max-w-[90vw]">
        ...
        <section>
            <div className='text-left bg-white relative h-[200vh] w-full pl-12'>
                <img src="/bg-logo.png" className="absolute left-10 h-[185vh] opacity-80" alt="Background Logo" /> {/* Fix scrollbar issue */}
                <div className="absolute top--5 left-0 w-full h-full flex px-20 pb-5 z-10">
                    <div className="text-black text-xl mx-80 px-5 ml-80 p-4">
