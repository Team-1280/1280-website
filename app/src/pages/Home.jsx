...
const Home = () => (
    <>
        <section className="relative h-[50dvw] w-full">
            ...
            <div className="relative flex flex-col items-center justify-center size-full text-center gap-10 overflow-hidden">
        ...
        <div className="relative w-full">
            <div className="bg-white flex px-12 py-12 h-225">
                <img src="/home3.png" className=''></img>
                <div className="min-w-75 mx-16 font-bricolage flex flex-col justify-around items-center">
