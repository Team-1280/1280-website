            ...
            <div className="relative min-h-screen w-full">
                <div className="absolute inset-0 bg-white flex px-4 pt-12 pb-12">
                    ...
                    <div className="font-bricolage">
                        <div className='absolute top-[7%] bg-linear-to-t from-[#717070] to-[#888888] rounded-lg border border-[#aaaaaa] border-1 shadow-lg/20 left-[22%] justify-center grid items-center w-6/8 h-1/4'>
