      ...
      <div className="w-full h-full px-8 py-8 flex flex-col items-start z-100 font-sans whitespace-nowrap">
        <div className="flex flex-row gap-83">
          <Link to="/" className="nav-item">
            <div className="text-lg mb-5 text-[#fcc307] font-bold w-auto">
              Team 1280
            </div>
          </Link>
          <div className="text-lg mb-5 text-[#fcc307] font-bold w-auto">
        ...
        <div className="flex flex-row gap-12 text-left flex-nowrap">
          <div>
            <Link to="/calendar" className="nav-item">
              <div className="block mb-5">Calendar</div>
            </Link>
            <Link to="/contact" className="nav-item">
              <div className="block mb-5">Contact</div>
            </Link>
          </div>
          <div>
            <Link to="/sponsors" className="nav-item">
              <div className="block mb-5">Sponsors</div>
            </Link>
            <Link to="/donate" className="nav-item">
              <div className="block mb-5">Sponsor Us</div>
            </Link>
          </div>
          <div>
            <Link to="/join" className="nav-item">
              <div className="block mb-5">Join Us</div>
            </Link>
          </div>
          <div>
